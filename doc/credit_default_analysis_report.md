...
first, we see that SVC had a final F1 test score of 0.403 while
`RandomForestClassifier` has an F1 test score of 0.538. As expected,
...
The models KNN and LogisticRegression have F1 test scores of 0.444 and
0.467 respectively.
